...
XI_API_KEY = "API"  # Your API key for authentication
VOICE_ID = "IKne3meq5aSn9XLyUdCD"  # ID of the voice model to use
AUDIO_FILE_PATH = "audios\\teste-rafa.mp3"  # Path to the input audio file
